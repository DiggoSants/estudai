...
.grid{display:grid;gap:18px}.stats{grid-template-columns:repeat(4,1fr);margin-bottom:20px}.card,.panel{background:rgba(13,22,40,.86);border:1px solid var(--border);border-radius:22px;padding:22px}.card small{color:var(--muted);font-weight:800;text-transform:uppercase;letter-spacing:.08em}.value{display:block;font-size:38px;font-weight:800;line-height:1;margin:12px 0 6px;background:var(--grad);-webkit-background-clip:text;-webkit-text-fill-color:transparent}.delta{display:inline-block;font-size:12px;border-radius:100px;padding:3px 9px;background:rgba(0,229,160,.1);color:var(--accent)}.delta.bad{background:rgba(255,107,107,.1);color:var(--danger)}
.ai{background:linear-gradient(160deg,rgba(0,229,160,.08),rgba(0,184,255,.045));border-color:rgba(0,229,160,.18);margin-bottom:20px}.panel-title{color:var(--muted);font-size:12px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;margin-bottom:18px;display:flex;justify-content:space-between}.two{grid-template-columns:1.55fr 1fr;margin-bottom:20px}.mat-item{display:flex;gap:12px;align-items:center;margin-bottom:14px}.mat-icon{width:36px;height:36px;border-radius:12px;display:grid;place-items:center;background:rgba(255,255,255,.05)}.mat-info{flex:1}.mat-top{display:flex;justify-content:space-between;font-weight:800;font-size:14px}.bar{height:7px;background:rgba(255,255,255,.06);border-radius:10px;overflow:hidden;margin-top:7px}.bar div{height:100%;border-radius:10px}.stack{display:grid;gap:18px}.streak{display:flex;gap:14px;align-items:center;background:rgba(0,229,160,.07);border:1px solid rgba(0,229,160,.14);border-radius:16px;padding:16px;margin-bottom:14px}.heat{display:grid;grid-template-columns:repeat(7,1fr);gap:7px}.day{aspect-ratio:1;border:1px solid var(--border);border-radius:10px;display:grid;place-items:center;color:var(--muted);font-size:11px}.day.active{background:rgba(0,229,160,.16);border-color:rgba(0,229,160,.3);color:var(--text)}.day.hot{background:rgba(0,184,255,.2);border-color:rgba(0,184,255,.4)}
.sim{display:flex;justify-content:space-between;gap:14px;align-items:center;background:rgba(255,255,255,.035);border:1px solid var(--border);border-radius:16px;padding:15px;margin-bottom:10px}.circle{width:48px;height:48px;border-radius:16px;display:grid;place-items:center;border:2px solid;font-weight:800}.sim-left{display:flex;gap:12px;align-items:center}.muted{color:var(--muted);font-size:13px}.badges{display:grid;grid-template-columns:repeat(5,1fr);gap:10px}.badge{aspect-ratio:1;border:1px solid var(--border);border-radius:16px;display:grid;place-items:center;text-align:center;padding:8px;color:var(--muted);font-size:11px}.badge span{font-size:22px}.badge.unlocked{background:rgba(0,229,160,.08);border-color:rgba(0,229,160,.22);color:var(--accent)}.badge.locked{opacity:.38;filter:grayscale(1)}.empty{text-align:center;color:var(--muted);padding:32px}.error-item{border-left:3px solid var(--danger);background:rgba(255,255,255,.035);border-radius:14px;padding:14px;margin-bottom:10px}
...
<main class="main">
  ...
  <section class="panel ai">
    <div class="panel-title">Analise IA - recomendacao do dia</div>
    <?php if($piorMateria): ?>
      <p>Seu ponto mais urgente agora e <strong style="color:var(--danger)"><?= e($piorMateria['nome']) ?> com <?= (int)$piorMateria['pct'] ?>%</strong>. <?php if($melhorMateria && $melhorMateria!==$piorMateria): ?>Seu ponto forte e <strong style="color:var(--accent)"><?= e($melhorMateria['nome']) ?> (<?= (int)$melhorMateria['pct'] ?>%)</strong>.<?php endif; ?></p>
    <?php else: ?>
      <p>Faca seu primeiro simulado para liberar recomendacoes personalizadas.</p>
    <?php endif; ?>
  </section>
