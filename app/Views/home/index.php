...
section{position:relative;z-index:1;padding:110px 7%}.bg2{background:var(--bg2)}.section-head{max-width:760px;margin-bottom:64px}.center{text-align:center;margin-left:auto;margin-right:auto}.tag{display:flex;align-items:center;gap:10px;color:var(--accent);font-size:11px;font-weight:800;letter-spacing:.15em;text-transform:uppercase;margin-bottom:16px}.center .tag{justify-content:center}.tag:before{content:"";width:24px;height:1px;background:var(--accent)}.center .tag:before{display:none}h2{font-size:clamp(34px,4.5vw,58px);line-height:1.08;letter-spacing:-.02em;margin-bottom:18px}.section-head p{color:var(--muted);font-size:18px}.steps,.cards{display:grid;gap:18px}.steps{grid-template-columns:repeat(4,1fr)}.step,.card,.quiz-card,.plan{background:var(--card);border:1px solid var(--border);border-radius:22px;padding:32px}.step-num{font:800 54px 'Syne';color:rgba(255,255,255,.05);margin-bottom:12px}.step h3,.card h3{font-size:19px;margin-bottom:10px}.step p,.card p,.plan li{color:var(--muted);font-size:14px}.cards{grid-template-columns:1.2fr 1fr 1fr}.card.big{grid-row:span 2;background:linear-gradient(160deg,var(--card2),var(--card) 65%)}.icon{width:54px;height:54px;border-radius:15px;display:grid;place-items:center;margin-bottom:20px;background:rgba(0,229,160,.1);font-size:24px}.demo{margin-top:26px;background:rgba(0,0,0,.26);border:1px solid rgba(0,229,160,.13);border-radius:16px;padding:20px}.demo-row{display:grid;grid-template-columns:100px 1fr 44px;gap:12px;align-items:center;margin-top:12px;color:var(--muted);font-size:13px}.bar{height:7px;background:rgba(255,255,255,.07);border-radius:4px;overflow:hidden}.fill{height:100%;background:var(--grad);border-radius:4px}
.quiz{display:grid;grid-template-columns:1fr 1.25fr;gap:64px;align-items:center}.quiz-card{background:var(--card2);box-shadow:0 40px 80px rgba(0,0,0,.35)}.quiz-top{display:flex;justify-content:space-between;color:var(--accent2);font-size:12px;font-weight:800;text-transform:uppercase;margin-bottom:20px}.question{font-size:17px;margin-bottom:20px}.opt{padding:14px 16px;border:1px solid var(--border);background:var(--card);border-radius:12px;margin-top:10px;cursor:pointer}.opt:hover,.opt.correct{border-color:var(--accent);background:rgba(0,229,160,.08)}.plans{display:grid;grid-template-columns:repeat(2,minmax(0,410px));justify-content:center;gap:24px}.plan.featured{border-color:rgba(0,229,160,.32);background:linear-gradient(160deg,rgba(0,229,160,.06),var(--card) 55%)}.price{font:800 54px 'Syne';margin:10px 0}.plan ul{list-style:none;display:grid;gap:10px;margin:22px 0}.cta{text-align:center;background:radial-gradient(ellipse at center,rgba(0,229,160,.08),transparent 70%)}.footer{position:relative;z-index:1;border-top:1px solid var(--border);padding:42px 7%;display:flex;justify-content:space-between;gap:22px;flex-wrap:wrap;color:var(--muted)}
